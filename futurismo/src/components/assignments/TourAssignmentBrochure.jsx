      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        <div className="bg-gray-50 rounded-lg p-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center py-2 border-b border-gray-200">
              ...
              <span className="font-bold text-gray-900">{tourName}</span>
            </div>
            <div className="flex justify-between items-center py-2 border-b border-gray-200">
              <span className="font-medium text-gray-600">Fecha:</span>
              <span className="font-bold text-gray-900">{new Date(tourDate).toLocaleDateString('es-PE', { 
                weekday: 'long', 
                year: 'numeric', 
                month: 'long', 
                day: 'numeric' 
            ...
            <div className="flex justify-between items-center py-2 border-b border-gray-200">
              ...
              <span className="font-bold text-gray-900">{tourTime}</span>
            </div>
            <div className="flex justify-between items-center py-2 border-b border-gray-200">
              <span className="font-medium text-gray-600">Grupo:</span>
              <span className="font-bold text-gray-900">{groupSize} personas</span>
            </div>
            <div className="flex justify-between items-center py-2">
              <span className="font-medium text-gray-600">Agencia:</span>
              <span className="font-bold text-blue-600">{agency.name}</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          ...
          <div className="bg-white rounded-lg p-4 border-l-4 border-green-500">
            <p className="text-lg font-bold text-gray-900 mb-2">{pickupLocation.name}</p>
            <p className="text-gray-600 mb-2">{pickupLocation.address}</p>
            <p className="text-sm text-gray-500">
              <strong>Referencia:</strong> {pickupLocation.reference}
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white border-2 border-blue-200 rounded-lg p-6 shadow-lg">
            <div className="text-center mb-4">
              ...
              <h5 className="text-xl font-bold text-gray-900">{guide.name}</h5>
            </div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-center">
                ...
                <span>Licencia: {guide.license}</span>
              </div>
              <div className="flex items-center">
                <StarIcon className="h-4 w-4 text-yellow-500 mr-2" />
                <span>Rating: {guide.rating} ⭐</span>
              </div>
              <div className="mt-3">
                <p className="text-xs text-gray-600">
                  <strong>Especialidades:</strong> {guide.specialties.join(', ')}
                </p>
              </div>
              <div className="mt-2">
                <p className="text-xs text-gray-600">
          ...
          <div className="bg-white border-2 border-green-200 rounded-lg p-6 shadow-lg">
            <div className="text-center mb-4">
              ...
              <h5 className="text-xl font-bold text-gray-900">{driver.name}</h5>
            </div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-center">
                <IdentificationIcon className="h-4 w-4 text-gray-500 mr-2" />
                <span>Licencia: {driver.license}</span>
              </div>
              <div className="mt-3">
                <p className="text-xs text-gray-600">
                  <strong>Experiencia:</strong> {driver.experience} años
                </p>
              </div>
              <div className="mt-2">
                <p className="text-xs text-gray-600">
                  <strong>Certificaciones:</strong> {driver.certifications.join(', ')}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border-2 border-purple-200 rounded-lg p-6 shadow-lg">
            <div className="text-center mb-4">
              ...
              <h5 className="text-xl font-bold text-gray-900">{vehicle.brand} {vehicle.model}</h5>
            </div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-bold">{vehicle.capacity} pasajeros</span>
              </div>
              <div className="mt-3">
                <p className="text-xs text-gray-600">
