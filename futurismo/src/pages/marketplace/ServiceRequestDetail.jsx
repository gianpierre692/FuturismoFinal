            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">${request.pricing.finalRate}</span>
                </div>
                ...
                {guide.preferences.requiresDeposit && request.status === 'accepted' && (
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                    <p className="text-sm text-yellow-800">
                      Depósito requerido: ${(request.pricing.finalRate * guide.preferences.depositPercentage / 100).toFixed(2)}
                    </p>
                  </div>
                )}
              </div>
