          ...
          <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-4 text-sm text-gray-600">
                ...
                <span>•</span>
                <span>${guide.pricing.hourlyRate}/hora</span>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                {guide.preferences.requiresDeposit && (
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-medium">
                      ${(calculatedPrice * guide.preferences.depositPercentage / 100).toFixed(2)}
                    </span>
                  </div>
                )}
                <div className="border-t border-gray-200 mt-2 pt-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xl font-bold text-gray-900">${calculatedPrice}</span>
                  </div>
                </div>
              </div>
